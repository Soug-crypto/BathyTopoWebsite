...
def home_page():
    ...
    #                             "maxScale": 3.0, 
    #                             "margin": 0.1, 
    #                             "plugins": ["highlight", "katex", "notes", "search", "zoom"]
    #                             }, 
    #                     initial_state={
    #                                     "indexh": 0, 
    #                                     "indexv": 0, 
    ...
    # st.write("Current State:", currState)  # Display the entire structure for debugging
...
def render_slide_content(currState):
    """Handle the content for index 2."""
